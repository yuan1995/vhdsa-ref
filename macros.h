...
#ifndef VHDSA_MACROS_H
#define VHDSA_MACROS_H

#include "vhdsa_defines.h"
...
#define VHDSA_UNUSED(x) UNUSED_##x __attribute__((unused))
#else
#define VHDSA_UNUSED(x) x
#endif
...
#define ALIGNU64T(s) ALIGNT(s, u64)
...
#define vhdsa_declassify(x, len) crypto_declassify((void*)x, len)
#elif defined(WITH_VALGRIND)
#include <valgrind/memcheck.h>
#define vhdsa_declassify(x, len) VALGRIND_MAKE_MEM_DEFINED(x, len)
#else
#define vhdsa_declassify(x, len)
#endif

...
static const u8 domain_sep_H0   = 0;
static const u8 domain_sep_H1   = 1;
static const u8 domain_sep_H2_0 = 8 + 0;
static const u8 domain_sep_H2_1 = 8 + 1;
static const u8 domain_sep_H2_2 = 8 + 2;
static const u8 domain_sep_H2_3 = 8 + 3;
static const u8 domain_sep_H3   = 3;
static const u8 domain_sep_H4   = 4;
...
void H0_update(H0_context_t* ctx, const u8* src, size_t len) {
  hash_update(ctx, src, len);
}

void H0_final(H0_context_t* ctx, u8* seed, size_t seed_len, u8* commitment,
...
void H0_x4_update(H0_context_x4_t* ctx, const u8* src0, const u8* src1,
...
void H1_update(H1_context_t* ctx, const u8* src, size_t len) {
  hash_update(ctx, src, len);
}

void H1_final(H1_context_t* ctx, u8* digest, size_t len) {
...
void H4_update(H4_context_t* ctx, const u8* iv) {

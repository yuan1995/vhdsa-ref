...
ATTR_TARGET_AESNI static void owf_128_aesni(const u8* key, const u8* input,
                                            u8* output) {
...
ATTR_TARGET_AESNI static void owf_192_aesni(const u8* key, const u8* input,
                                            u8* output) {
...
ATTR_TARGET_AESNI static void owf_256_aesni(const u8* key, const u8* input,
                                            u8* output) {
...
ATTR_TARGET_AESNI_AVX2 static void owf_128_aesni_avx2(const u8* key, const u8* input,
                                                      u8* output) {
  __m128i rk[AES_ROUNDS_128 + 1];
...
ATTR_TARGET_AESNI_AVX2 static void owf_192_aesni_avx2(const u8* key, const u8* input,
                                                      u8* output) {
  __m128i rk[AES_ROUNDS_192 + 1];
...
ATTR_TARGET_AESNI_AVX2 static void owf_256_aesni_avx2(const u8* key, const u8* input,
                                                      u8* output) {
  __m128i rk[AES_ROUNDS_256 + 1];

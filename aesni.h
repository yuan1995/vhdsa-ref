#ifndef VHDSA_AESNI_H
#define VHDSA_AESNI_H
...
ATTR_TARGET_AESNI static inline void aes128_expand_key_aesni(__m128i* rk, const u8* key) {
...
ATTR_TARGET_AESNI static inline void aes192_expand_key_aesni(__m128i* rk, const u8* key) {
  __m128i temp[2];
  rk[0]   = _mm_loadu_si128((const __m128i_u*)key);
...
ATTR_TARGET_AESNI static inline void aes256_expand_key_aesni(__m128i* rk, const u8* key) {
  rk[0]  = _mm_loadu_si128((const __m128i_u*)key);

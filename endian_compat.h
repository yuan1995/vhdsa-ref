#ifndef VHDSA_COMPAT_ENDIAN_H
#define VHDSA_COMPAT_ENDIAN_H
...
#else
static inline u16 ATTR_CONST bswap16(u16 x) {
  return ((x & 0xff00) >> 8) | ((x & 0x00ff) << 8);
}

static inline u32 ATTR_CONST bswap32(u32 x) {
  return ((x & 0xff000000) >> 24) | ((x & 0x00ff0000) >> 8) | ((x & 0x0000ff00) << 8) |
         ((x & 0x000000ff) << 24);
}

static inline u64 ATTR_CONST bswap64(u64 x) {
...
#if !defined(VHDSA_IS_LITTLE_ENDIAN) && !defined(VHDSA_IS_BIG_ENDIAN)
#if defined(BIG_ENDIAN) && defined(LITTLE_ENDIAN)
#if defined(BYTE_ORDER) && BYTE_ORDER == BIG_ENDIAN
#define VHDSA_IS_BIG_ENDIAN
...
#if defined(VHDSA_IS_LITTLE_ENDIAN)
...
#elif defined(VHDSA_IS_BIG_ENDIAN)
